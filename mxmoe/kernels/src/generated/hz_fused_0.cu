    ...
    int* problem_tiles_prefix_sum        //
        ...
        while (true) {
            ...
            if (a_bits == 16 && w_bits == 16) {
              using TileCfg = TileConfig<128,128,64,2,2,1,3,-1,MMA_FP16_FP32,NO_QUANT,NO_QUANT>;
...
void groupgemm_hz_fused_0(                      //
  ...
  // auto kernel     = groupgemm_hz_fused_0_impl<TileConfig<128,128,64,2,2,1,3,-1,MMA_FP16_FP32,NO_QUANT,NO_QUANT>>;
  auto kernel     = groupgemm_hz_fused_0_impl;
...
struct Register_groupgemm_hz_fused_0{Register_groupgemm_hz_fused_0(){register_kernel<TileConfig<128,128,64,2,2,1,3,-1,MMA_FP16_FP32,NO_QUANT,NO_QUANT>>(&groupgemm_hz_fused_0,"groupgemm_hz_fused_0");}};static Register_groupgemm_hz_fused_0 register_groupgemm_hz_fused_0;
} // namespace mxmoe
