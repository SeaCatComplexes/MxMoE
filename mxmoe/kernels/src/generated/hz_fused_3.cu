...
__global__ void groupgemm_hz_fused_3_impl (     //
    ...
    int* problem_tiles_prefix_sum        //
        ...
        auto smem_scale_zp = reinterpret_cast<half*>(smem + 49152);
        ...
        while (true) {
            ...
            if (a_bits == 16 && w_bits == 16) {
              using TileCfg = TileConfig<128,128,32,2,4,1,3,-1,MMA_FP16_FP32,NO_QUANT,NO_QUANT>;
...
void groupgemm_hz_fused_3(                      //
  ...
  // auto kernel     = groupgemm_hz_fused_3_impl<TileConfig<128,128,32,2,4,1,3,-1,MMA_FP16_FP32,NO_QUANT,NO_QUANT>>;
  auto kernel     = groupgemm_hz_fused_3_impl;

  int dev_id;
  int num_sm;
  int max_active_blocks;
  int num_threads=32*8;
  size_t smem_size=49152;
...
struct Register_groupgemm_hz_fused_3{Register_groupgemm_hz_fused_3(){register_kernel<TileConfig<128,128,32,2,4,1,3,-1,MMA_FP16_FP32,NO_QUANT,NO_QUANT>>(&groupgemm_hz_fused_3,"groupgemm_hz_fused_3");}};static Register_groupgemm_hz_fused_3 register_groupgemm_hz_fused_3;
} // namespace mxmoe
