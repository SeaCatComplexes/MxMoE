    ...
    int* problem_tiles_prefix_sum        //
        ...
        while (true) {
            ...
            if (a_bits == 16 && w_bits == 16) {
              using TileCfg = TileConfig<128,128,32,2,2,1,3,-1,MMA_FP16_FP32,NO_QUANT,NO_QUANT>;
...
void groupgemm_hz_fused_2(                      //
  ...
  // auto kernel     = groupgemm_hz_fused_2_impl<TileConfig<128,128,32,2,2,1,3,-1,MMA_FP16_FP32,NO_QUANT,NO_QUANT>>;
  auto kernel     = groupgemm_hz_fused_2_impl;
...
struct Register_groupgemm_hz_fused_2{Register_groupgemm_hz_fused_2(){register_kernel<TileConfig<128,128,32,2,2,1,3,-1,MMA_FP16_FP32,NO_QUANT,NO_QUANT>>(&groupgemm_hz_fused_2,"groupgemm_hz_fused_2");}};static Register_groupgemm_hz_fused_2 register_groupgemm_hz_fused_2;
} // namespace mxmoe
